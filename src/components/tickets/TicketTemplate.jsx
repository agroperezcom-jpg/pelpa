  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: "8px" }}>
        <div style={{ fontWeight: "bold", fontSize: "13px" }}>{comercio_nombre}</div>
      ...
      <div style={{ borderTop: "1px dashed #000", borderBottom: "1px dashed #000", padding: "4px 0", marginBottom: "8px", textAlign: "center" }}>
        <div style={{ fontWeight: "bold", fontSize: "12px" }}>{titleText}</div>
      ...
      {/* Items Header */}
      <div style={{ display: "grid", gridTemplateColumns: "2fr 0.8fr 1fr 1fr", gap: "2px", fontSize: "9px", fontWeight: "bold", marginBottom: "4px" }}>
        <div>ARTÍCULO</div>
      ...
      <div style={{ borderTop: "1px dashed #000", borderBottom: "1px dashed #000", paddingTop: "4px", paddingBottom: "4px", marginBottom: "4px" }}>
        {items.map((item, idx) => (
          <div key={idx} style={{ display: "grid", gridTemplateColumns: "2fr 0.8fr 1fr 1fr", gap: "2px", fontSize: "9px", marginBottom: "3px" }}>
      ...
      <div style={{ marginBottom: "8px", fontSize: "10px" }}>
        ...
        <div style={{ borderTop: "1px dashed #000", paddingTop: "4px", display: "flex", justifyContent: "space-between", fontWeight: "bold", fontSize: "12px" }}>
          <span>TOTAL:</span>
      ...
      {/* Forma de pago */}
      {forma_pago && (
        <div style={{ marginBottom: "8px", fontSize: "10px", borderTop: "1px dashed #000", paddingTop: "4px" }}>
